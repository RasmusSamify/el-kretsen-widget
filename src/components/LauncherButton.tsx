...
export function LauncherButton({ open, onClick }: { open: boolean; onClick: () => void }) {
  return (
    <button
      ...
      className="group relative flex h-14 w-14 items-center justify-center rounded-full bg-gradient-to-br from-brand-400 via-brand-500 to-brand-700 text-white shadow-widget transition hover:scale-105 active:scale-95"
    >
